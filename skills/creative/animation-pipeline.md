...
Animation work in OpenNolan runs on one of two composition runtimes. Both
...
| **Web/explainer standard** | 30 | Default for YouTube/web video. OpenNolan default. |
...
**OpenNolan default:** 30fps. Render Manim at 60fps and transcode to 30fps for smoother motion at delivery frame rate.
...
1. **Render at 30fps** (OpenNolan default) — Manim at 60fps, transcode down
