...
| Layer 3 | `.agents/app/skills/flux-best-practices/`, `.agents/app/skills/beautiful-mermaid/`, `.agents/app/skills/manim-composer/` | Image gen, diagram, animation knowledge |
