...
1. Prefer free/public sources first: web search, platform trend pages, Google Trends, TikTok Creative Center, public competitor posts, YouTube pages/transcripts, Reddit, newsletters/blogs, and existing Hermes tools.
...
Append durable recommendations to `~/.hermes/marketing-os/tool-wishlist.md`.
