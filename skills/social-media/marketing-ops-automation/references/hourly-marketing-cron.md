...
This reference captures a concrete Content OS cron setup that can be adapted for future users.
...
1. **Hourly trend scout**
   ...
   - Output: `~/content-os/trends/YYYY-MM-DD.jsonl`
...
3. **Approved scripts**
   ...
   - Output: `~/content-os/scripts/YYYY-MM-DD/idea-N.md`
...
4. **Production**
   ...
   - Output: `~/content-os/productions/YYYY-MM-DD/idea-N/`
...
- Maintain `~/content-os/tool-wishlist.md` for exact tool/API/Actor recommendations discovered during research.
