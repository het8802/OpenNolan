# Local motion-graphics fallback for Content OS shorts
...
Do not reuse identical scene order, palette, lower-third style, or animations across Content OS videos; adapt the pattern to the new story.