...
description: Use when Het shares an Instagram carousel, reference post, or carousel link in daily-carousels and asks to create, adapt, remix, or modify it for his AI/tech carousel brand.
---

# Daily Carousel Remix

## Core principle
Treat shared carousels as **structure references**, not copy targets. Extract the hook pattern, slide rhythm, visual device, and CTA mechanic, then rebuild the idea for Het’s AI/tech audience in the established Anthropic-inspired theme.
...
Het’s carousel brand is Anthropic-inspired:
...
3. **Rewrite for Het’s niche:** AI, tech, startups, founders, operators, builders, product strategy, automation, or daily tech/news depending on the prompt.
...
8. **Ask Het to post it** after delivery/review. Use a direct closing prompt such as: “Want me to post this now?” or “Should I queue/post this carousel?”

## Remix guardrails
- Do not plagiarize the original carousel’s exact copy or design. Convert it into a new Het-branded version.
...
- If the reference is purely content/strategy, express it using Het’s warm Anthropic-inspired editorial design system.
...
- Suggested post prompt to Het asking whether to post/queue it.

## Current source note
Het shared `instagram.com/p/DX9UfbMjMMf/?img_index=1` as an example for this workflow. Web extraction may not expose Instagram content, so future uses should inspect screenshots/previews from Slack or ask for frames if needed.
