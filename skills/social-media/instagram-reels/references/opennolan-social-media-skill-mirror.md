...
- Content-OS runtime skills: `~/content-os/skills/social-media/`
...
1. Patch the relevant content-OS skill first (`instagram-reels`, `instagram-carousel`, or another social-media umbrella).
...
- Do not store only in OpenNolan; the content-OS will not reliably apply it in future sessions.
