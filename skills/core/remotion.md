...
The **installed agent skills** (`.agents/app/skills/remotion-best-practices/`) teach correct
Remotion API usage — imports, timing, animation constraints, code patterns.
**This file** teaches how OpenNolan uses Remotion — which compositions map to pipeline
...
| OpenNolan Artifact | Remotion Prop | Maps To |
|---------------------|---------------|---------|
...
| OpenNolan Profile | Remotion Config |
|--------------------|-----------------|
