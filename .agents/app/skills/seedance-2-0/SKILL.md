...
| Surface | Env | OpenNolan tool | Status | Notes |
|---|---|---|---|---|
| **fal.ai** (primary) | `FAL_KEY` | `seedance_video` | ✅ wrapped | Model IDs below. Supports T2V, I2V, reference-to-video; `standard` and `fast` variants. Default in OpenNolan. |
...
## Calling Seedance 2.0 inside OpenNolan
...
## Integration notes for OpenNolan pipelines
