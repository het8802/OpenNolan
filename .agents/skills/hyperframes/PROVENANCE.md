...
cp -r ~/hyperframes/skills/hyperframes          .agents/skills/
cp -r ~/hyperframes/skills/hyperframes-cli      .agents/skills/
cp -r ~/hyperframes/skills/hyperframes-registry .agents/skills/
cp -r ~/hyperframes/skills/website-to-hyperframes .agents/skills/
