"""Bridge OpenNolan playbooks → HyperFrames-friendly style artifacts.

OpenNolan playbooks are YAML files describing visual_language, typography,
...
def _render_design_md(
    ...
    lines = [
        title,
        "",
        f"> Generated by OpenNolan HyperFrames style bridge (source: {source_note}).",
        "",
        "## Colors",
        "",
